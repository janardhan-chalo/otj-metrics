...
public class HealthApiTest {
    ...
    public void testOk() {
        ...
        try(Response r = resource.getHealth(false)){
    ...
    public void testMixed() {
        ...
        try(Response r = resource.getHealth(true)){
            assertEquals(500, r.getStatus());
    ...
    public void testGroupHappyCase() {
        ...
        try(Response r2 = resource.getHealthGroup("mygroup", false)){
    ...
    public void testGroupUnknownGroupIs404() {
        ...
        try(Response r2 = resource.getHealthGroup("nogroup", true)){
    ...
    public void testGroupUnhealthy() {
        ...
        try(Response r2 = resource.getHealthGroup("mygroup", true)){
